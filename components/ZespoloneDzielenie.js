...
const ZespoloneDzielenie = () => {
    ...
    const calculateResult = () => {
        ...
        const denominator = parsedValue3 * parsedValue3 + parsedValue4 * parsedValue4;
        const calculatedResult = (parsedValue1 * parsedValue3 + parsedValue2 * parsedValue4) / denominator;
        const calculatedResult2 = (parsedValue2 * parsedValue3 - parsedValue1 * parsedValue4) / denominator;
...
export default ZespoloneDzielenie;
