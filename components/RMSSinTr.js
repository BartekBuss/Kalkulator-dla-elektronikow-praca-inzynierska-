...
const RMSSinTr = () => {
  ...
  const [selectedOption1, setSelectedOption1] = useState(1); // Ustaw domyślną wartość na mikro

  const calculateResult = () => {
    const parsedValue1 = parseFloat(value1) * selectedOption1;
    const calculatedResult = parsedValue1 / Math.sqrt(2);
